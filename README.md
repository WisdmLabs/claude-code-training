...
1. **Sequential learners**: Work through modules 0-11 in order
2. **Experienced users**: Jump to modules 5+ for advanced patterns
3. **Quick reference**: Each module has a TL;DR section at the top
